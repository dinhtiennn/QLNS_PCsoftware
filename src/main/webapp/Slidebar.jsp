...
function toggleSize() {
	...
	<ul class="nav flex-column">
	  ...
	  <li class="nav-item">
	    <a class="nav-link" href="">Lịch trình tháng</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" href="">Đăng ký làm việc</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" href="">Danh sách nghỉ</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" href="">Thống kê lương</a>
	  </li>
	</ul>